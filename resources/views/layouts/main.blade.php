...
<body class="p-6 ">
<label class="absolute top-0 right-0 mt-4 mr-4 swap swap-rotate">
...
<div class="max-w-md mx-auto rounded p-6 shadow-md transform">
    <h1 class="text-4xl font-bold mb-4 text-center text-transparent bg-gradient-to-r from-red-500 via-blue-500 to-green-500 bg-clip-text">URL Shortener</h1>
    @yield('content')
</div>
</body>
</html>